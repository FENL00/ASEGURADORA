...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($accion == 'actualizar'){
        ...
        if($identificacionvieja == $identificacion){
            $operacion->actualizarusuario($identificacionvieja,$nombres,$apellidos,$celular,$correo,$contrasena,$rol, $id);
            ...
            <div class="table-responsive">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $personal=$operacion->mostrarpersonas(); 
                        foreach ($personal as $dato) { ?>
                            <tr>
                                ...
                                <td><?php echo $dato["p_fechanacimiento"] ?></td>
                                <td><?php echo $dato["p_cargo"] ?></td>
                                <td><?php echo $dato["p_tiposeguro"] ?></td>
                                <td><?php echo $dato["p_estadoseguro"] ?></td>
                                <td>
                        <center>
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#actualizar<?php echo $dato['p_id'] ?>" >
                                Ver
                            </button>

                        </center> 
                        <div class="modal fade" id="actualizar<?php echo $dato['p_id'] ?>" tabindex="-1" aria-hidden="true">
    ...
    <input type="password" class="form-control" id="contrasena"  name="contrasena" placeholder="Ingresar Contraseña"  value = "<?php echo !empty($dato['u_contrasena']) ? $dato['u_contrasena'] : ''; ?>" required>
                        ...
                        <!--ELIMINAR-->
                                ...
                                <td>
                                    ...
                                    <input type="hidden" class="form-control form-control-sm" name="id_per" id="id_per" value = "<?php echo $dato["p_id"]; ?>">
                                ...
                                <td>
                                    <a href="personaactualizar.php?id=<?php echo $dato["u_id"] ?>" class="btn btn-success">Actualizar</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
