...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($placavieja == "") { // registreme
        if ($placaexiste == 0) {
            $operacion->nuevovehiculo($id_usuario, $uso, $placa, $matricula, $tipovehiculo, $marca, $modelo, $licencia, $tiposeguro, $estadoseguro);
        ...
        $id = $_POST["id"];
        if ($placa == $placavieja) {
            $operacion->actualizarvehiculo($id_usuario, $uso, $placavieja, $matricula, $tipovehiculo, $marca, $modelo, $licencia, $tiposeguro, $estadoseguro, $id);
            echo '<script language="javascript">alert("Se actualizo correctamente");</script>';
        } else {
            if ($placaexiste == 0) {
                $operacion->actualizarvehiculo($id_usuario, $uso, $placa, $matricula, $tipovehiculo, $marca, $modelo, $licencia, $tiposeguro, $estadoseguro, $id);
...
?>
                    <?php
$dat = $operacion->buscarvehiculo($id_usuario);
?>
