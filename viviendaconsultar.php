...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($numeroescrituravieja == ""){ // registreme
        if($escrituraexiste == 0){
            $operacion->nuevavivienda($id_usuario, $tipovivienda, $numeroescritura, $zona, $estrato, $departamento, $ciudad, $direccion, $tiposeguro, $estadoseguro);
      ...
      if($numeroescritura == $numeroescrituravieja){
        $operacion->actualizarvivienda($id_usuario, $tipovivienda, $numeroescrituravieja, $zona, $estrato, $departamento, $ciudad, $direccion, $tiposeguro, $estadoseguro, $id);
        echo '<script language="javascript">alert("Se actualizo correctamente");</script>';
      }else{
        if($escrituraexiste == 0){
            $operacion->actualizarvivienda($id_usuario, $tipovivienda, $numeroescritura, $zona, $estrato, $departamento, $ciudad, $direccion, $tiposeguro, $estadoseguro, $id);
...
<div class="container">
        <div class="card ">
            <div class="card-header text-white bg-primary" >
                ...
                <?php if ($id_rol == 1) {
    ?>
                <a href="listarpersona.php" class="btn btn-primary bg-info">lista de seguro de persona</a></div>
                     <?php
} else {
    ?>
                        <?php
...
?>
                    <?php
$dat = $operacion->buscarvivienda($id_usuario);
?>
