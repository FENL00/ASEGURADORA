...
<body>
        ...
        <div class="card">
            <div class="card-header text-white bg-primary" >
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <strong>Lista de Vivienda Asegurados</strong>
                    </div>
                    <div class="col">
                        <form class="row" action="viviendalistarbuscar.php" method="GET">
                          <div class="col-9">
                            <input type="number" class="form-control form-control-sm" id="identificacion" name="identificacion" placeholder="Ingrese la Identificación">
                        </div>
                        <div class="col-3">
        ...
        <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php 
                    $vivienda=$operacion->mostrarviviendaidentificacion($identificacionurl); 
                    foreach ($vivienda as $dato) { ?>
                        <tr>
                        <td><?php echo $dato["u_identificacion"] ?></td>
                                <td><?php echo $dato["u_nombres"] . " " . $dato["u_apellidos"] ?></td>
                            <td><?php echo $dato["vi_tipovivienda"] ?></td>
                            <td><?php echo $dato["vi_escritura"] ?></td>

                            <td><?php echo $dato["vi_departamento"] ?></td>

                            <td><?php echo $dato["vi_ciudad"] ?></td>
                            <td><?php echo $dato["vi_direccion"] ?></td>
                            <td><?php echo $dato["vi_zona"] ?></td>

                            <td><?php echo $dato["vi_tiposeguro"] ?></td>
                                <td><?php echo $dato["vi_estadoseguro"] ?></td>
                                <td>
                        <center>
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#actualizar<?php echo $dato['vi_id'] ?>" >
                                Ver
                            </button>

                        </center> 
                        <div class="modal fade" id="actualizar<?php echo $dato['vi_id'] ?>" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form  ROLE="FORM" METHOD="POST" ACTION="">
                                            ...
                                            <input type="hidden" class="form-control" id="id_us" name="id_us" value = "<?php echo!empty($dato['u_id']) ? $dato['u_id'] : ''; ?>"  required>
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control" id="contrasena"  name="contrasena" placeholder="Ingresar Contraseña"  value = "<?php echo !empty($dato['u_contrasena']) ? $dato['u_contrasena'] : ''; ?>" required>
                                    ...
                                    <div class="modal-footer">
                                       ...
                                       <td>
                                    <form  action="" method="POST" onSubmit="return confirm('¿Desea eliminar la informacion del Cliente?')">
                                    <input type="hidden" class="form-control" id="accion" name="accion"  value="eliminar">   
                                    <input type="hidden" class="form-control form-control-sm" name="id_vivi" id="id_vivi" value = "<?php echo $dato["vi_id"]; ?>">
                                ...
                                <td>
                                    <a href="viviendaactualizar.php?id=<?php echo $dato["u_id"] ?>" class="btn btn-success">Actualizar</a>
                                </td>
                        </tr>
                    <?php } ?>
                </tbody>
