        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $vehiculo = $operacion->mostrarvehiculo();
                        foreach ($vehiculo as $dato) { ?>
                            <tr>
                                <td><?php echo $dato["u_identificacion"] ?></td>
                                <td><?php echo $dato["u_nombres"] . " " . $dato["u_apellidos"] ?></td>
                                <td><?php echo $dato["v_uso"] ?></td>

                                <td><?php echo $dato["v_placa"] ?></td>
                                <td><?php echo $dato["v_tipovehiculo"] ?></td>
                                <td><?php echo $dato["v_modelo"] ?></td>
                                <td><?php echo $dato["v_marca"] ?></td>
                                <td><?php echo $dato["v_tiposeguro"] ?></td>
                                <td><?php echo $dato["v_estadoseguro"] ?></td>
                                <td>
                                    <center>
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#actualizar<?php echo $dato['v_id'] ?>">
                                            Ver
                                        </button>

                                    </center>
                                    <div class="modal fade" id="actualizar<?php echo $dato['v_id'] ?>" tabindex="-1" aria-hidden="true">
                                ...
                                <td>
                                    <form action="" method="POST" onSubmit="return confirm('¿Desea eliminar la informacion del Cliente?')">
                                        ...
                                        <input type="hidden" class="form-control form-control-sm" name="id_auto" id="id_auto" value="<?php echo $dato["v_id"]; ?>">
                                ...
                                <td>
                                    <a href="autoactualizar.php?id=<?php echo $dato["u_id"] ?>" class="btn btn-success">Actualizar</a>
                                </td>
